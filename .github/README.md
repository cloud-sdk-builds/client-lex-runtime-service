...
[`@aws-sdk/client-lex-runtime-service`](https://www.npmjs.com/package/@aws-sdk/client-lex-runtime-service/v/3.1127.0).
...
- @aws-sdk/client-lex-runtime-service v3.1127.0 - [https://cloud-sdk-builds.github.io/?sdk=client-lex-runtime-service&version=3.1127.0](https://cloud-sdk-builds.github.io/?sdk=client-lex-runtime-service&version=3.1127.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-runtime-service@3.1127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V6uOR2CwbZeMPtwufFdzrAcNDooBfqoyVA1gGeF7JqI2heJ+BnNxwVYCgteurx5F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lex-runtime-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-runtime-service@3.1127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-runtime-service@3.1127.0/index.min.mjs": "sha384-V6uOR2CwbZeMPtwufFdzrAcNDooBfqoyVA1gGeF7JqI2heJ+BnNxwVYCgteurx5F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lex-runtime-service/blob/refs/tags/3.1127.0/LICENSE
```
