...
[`@aws-sdk/client-lex-runtime-service`](https://www.npmjs.com/package/@aws-sdk/client-lex-runtime-service/v/3.1111.0).
...
- @aws-sdk/client-lex-runtime-service v3.1111.0 - [https://cloud-sdk-builds.github.io/?sdk=client-lex-runtime-service&version=3.1111.0](https://cloud-sdk-builds.github.io/?sdk=client-lex-runtime-service&version=3.1111.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-runtime-service@3.1111.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kATTBgJxk7oIPePOMIGQ+XsiYcCzIhgLRBDF4+vgAYxSrEuG+rt6g/l3SHoNwpAM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lex-runtime-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-runtime-service@3.1111.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lex-runtime-service@3.1111.0/index.min.mjs": "sha384-kATTBgJxk7oIPePOMIGQ+XsiYcCzIhgLRBDF4+vgAYxSrEuG+rt6g/l3SHoNwpAM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lex-runtime-service/blob/refs/tags/3.1111.0/LICENSE
```
